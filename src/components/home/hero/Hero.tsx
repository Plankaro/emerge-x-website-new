      ...
      <div className=" absolute left-0 bottom-8 sm:bottom-0 w-full ">
        <div className=" p-4  sm:p-12 pb-10 w-full  ">
          <div>
            ...
            >
              <span className="text-[38px] md:text-[58px] font-[700] text-white leading-[60px] md:leading-[70px]  ">

              Reliable 
              </span>
              <br />
              <span className="text-customGreen text-[32px] md:text-[52px] leading-[38px] md:leading-[68px] font-[700] ">Emergency management </span>
            </motion.h2>
